                ...
                <div className="footer__grid">
                    <div>
                        ...
                        <div className="footer__social">
                            ...
                            <a href="mailto:rathnakumar.udayakumar@gmail.com" className="footer__social-link" aria-label="Email">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                                </svg>
                            </a>
                            <a href="https://calendly.com/rathnakumarudayakumar" className="footer__social-link" aria-label="Schedule a call" target="_blank" rel="noopener noreferrer">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div>
                        ...
                        <a href="mailto:rathnakumar.udayakumar@gmail.com" className="footer__link">
                            rathnakumar.udayakumar@gmail.com
                        </a>
                        <a href="https://calendly.com/rathnakumarudayakumar" className="footer__link" target="_blank" rel="noopener noreferrer">
                            Schedule a Call
                        </a>
                    </div>
                </div>
