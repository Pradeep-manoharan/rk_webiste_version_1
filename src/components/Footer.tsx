                ...
                <div className="footer__grid">
                    <div>
                        ...
                        <div className="footer__social">
                            ...
                            <a href="https://www.instagram.com/rathanuday/" className="footer__social-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://calendly.com/rathnakumar_udayakumar/lets_connect" className="footer__social-link" aria-label="Schedule a call" target="_blank" rel="noopener noreferrer">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div>
                        ...
                        <a href="https://calendly.com/rathnakumar_udayakumar/lets_connect" className="footer__link" target="_blank" rel="noopener noreferrer">
                            Schedule a Call
                        </a>
                    </div>
                </div>
